    ...
    def create_image(self):
        ...
        for i in a:
            ...
            if os.path.exists(file_path):
                ...
                dem=1
                globals()[variable_name].script('moveto 0 1 0 0 90;')
                globals()[variable_name].script('write IMAGE 224 224 PNG 100 '+name_image) 
                self.press_enter(0.5)
           #Hình thứ 3 xoay trục x 180 độ 
            ...
            if os.path.exists(file_path):
                ...
                dem=1
                globals()[variable_name].script('moveto 0 1 0 0 180;')
                globals()[variable_name].script('write IMAGE 224 224 PNG 100 '+name_image) 
                self.press_enter(0.5)
           #Hình thứ 4 xoay trục x 270 độ 
            ...
            if os.path.exists(file_path):
                ...
                dem=1
                globals()[variable_name].script('moveto 0 1 0 0 270;')
                globals()[variable_name].script('write IMAGE 224 224 PNG 100 '+name_image) 
                self.press_enter(0.5)
            #Hình thứ 5 xoay trục y 90 độ    
            
            name_image=i.replace('.pdb','_5.png')
            file_path=folder_save+'/'+name_image
            if os.path.exists(file_path):
                globals()[variable_name].close()
            else:
                ...
                dem=1
                globals()[variable_name].script('moveto 0 0 1 0 90;')
                globals()[variable_name].script('write IMAGE 224 224 PNG 100 '+name_image) 
                self.press_enter(0.5)
            #Hình thứ 6 xoay trục y 270 độ
            
            name_image=i.replace('.pdb','_6.png')
            file_path=folder_save+'/'+name_image
            if os.path.exists(file_path):
                globals()[variable_name].close()
            else:
                ...
                dem=1
                globals()[variable_name].script('moveto 0 0 1 0 270;')
                globals()[variable_name].script('write IMAGE 224 224 PNG 100 '+name_image) 
                self.press_enter(0.5)
